System.register("SerializerSettings", [], function (exports_1, context_1) {
    "use strict";
...
System.register("Constructor", [], function (exports_2, context_2) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            Constants = (function () {
                ...
                Constants.METADATA_FIELD_KEY = "__typedJsonJsonObjectMetadataInformation__";
                return Constants;
            }());
...
System.register("Helpers", ["Constants"], function (exports_4, context_4) {
    "use strict";
    var __moduleName = context_4 && context_4.id;
    var Constants_1, Helpers;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_4("default", Helpers);
            //#endregion 
        }
    };
});
System.register("JSON", [], function (exports_5, context_5) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            exports_5("default", JSON);
        }
    };
});
System.register("TypedJSON", [], function (exports_6, context_6) {
    "use strict";
...
System.register("JsonMemberMetadata", [], function (exports_7, context_7) {
    "use strict";
    var __moduleName = context_7 && context_7.id;
    var JsonMemberMetadata;
    return {
        setters: [],
        execute: function () {
            JsonMemberMetadata = (function () {
                function JsonMemberMetadata() {
                }
                return JsonMemberMetadata;
            }());
            exports_7("JsonMemberMetadata", JsonMemberMetadata);
        }
    };
});
System.register("JsonObjectMetadata", ["Helpers", "Constants"], function (exports_8, context_8) {
    "use strict";
    var __moduleName = context_8 && context_8.id;
    var Helpers_1, Constants_2, JsonObjectMetadata;
    return {
        setters: [
        ...
        execute: function () {
            JsonObjectMetadata = (function () {
                ...
                JsonObjectMetadata.getFromType = function (target, inherited) {
                    ...
                    if (targetPrototype.hasOwnProperty(Constants_2.Constants.METADATA_FIELD_KEY)) {
                        // The class prototype contains own JsonObject metadata.
                        metadata = targetPrototype[Constants_2.Constants.METADATA_FIELD_KEY];
                    }
                    else if (inherited && targetPrototype[Constants_2.Constants.METADATA_FIELD_KEY]) {
            ...
            exports_8("JsonObjectMetadata", JsonObjectMetadata);
        }
    };
});
System.register("ReadSettings", [], function (exports_9, context_9) {
    "use strict";
...
System.register("Deserializer", ["JsonObjectMetadata", "Helpers"], function (exports_10, context_10) {
    "use strict";
    var __moduleName = context_10 && context_10.id;
    var JsonObjectMetadata_1, Helpers_2, Deserializer;
    return {
        setters: [
            function (JsonObjectMetadata_1_1) {
                JsonObjectMetadata_1 = JsonObjectMetadata_1_1;
            },
        ...
        execute: function () {
            Deserializer = (function () {
                ...
                Deserializer.countObjects = function (value) {
                    ...
                    switch (typeof value) {
                        case "object":
                            ...
                            else if (Helpers_2.default.isArray(value)) {
                ...
                Deserializer.readJsonToInstance = function (json, settings) {
                    ...
                    var temp;
                    var knownTypes;
                    if (!Helpers_2.default.valueIsDefined(json)) {
                    ...
                    else if (Helpers_2.default.isPrimitive(settings.objectType)) {
                        // number, string, boolean: assign directly.
                        if (json.constructor !== settings.objectType) {
                            var expectedTypeName = Helpers_2.default.getClassName(settings.objectType).toLowerCase();
                            var foundTypeName = Helpers_2.default.getClassName(json.constructor).toLowerCase();
                        ...
                        if (!Helpers_2.default.isArray(json)) {
                            throw new TypeError("Expected value to be of type 'Array', got '" + Helpers_2.default.getClassName(json.constructor) + "'.");
                        }
                        object = [];
                        ...
                        if (typeHint && settings.enableTypeHints) {
                            ...
                            if (settings.strictTypeHintMode && !Helpers_2.default.isSubtypeOf(settings.knownTypes[typeHint], settings.objectType)) {
                                throw new Error("'" + typeHint + "' is not a subtype of '" + Helpers_2.default.getClassName(settings.objectType) + "'.");
                            }
                        ...
                        if (objectMetadata) {
                            if (typeof objectMetadata.initializer === "function") {
                                ...
                                Object.keys(objectMetadata.dataMembers).forEach(function (propertyKey) {
                                    ...
                                    temp = _this.readJsonToInstance(json[propertyMetadata.name], {
                                        ...
                                        knownTypes: Helpers_2.default.merge(settings.knownTypes, objectMetadata.knownTypes || {}),
                                    ...
                                    if (Helpers_2.default.valueIsDefined(temp)) {
                            ...
                            Object.keys(json).forEach(function (propertyKey) {
                                ...
                                if (json[propertyKey] && propertyKey !== settings.typeHintPropertyKey) {
                                    ...
                                    if (Helpers_2.default.valueIsDefined(json[propertyKey])) {
            ...
            exports_10("Deserializer", Deserializer);
        }
    };
});
System.register("WriteSettings", [], function (exports_11, context_11) {
    "use strict";
...
//#region "Serializer"
System.register("Serializer", ["JsonObjectMetadata", "Helpers"], function (exports_12, context_12) {
    "use strict";
    var __moduleName = context_12 && context_12.id;
    var JsonObjectMetadata_2, Helpers_3, Serializer;
    return {
        setters: [
            function (JsonObjectMetadata_2_1) {
                JsonObjectMetadata_2 = JsonObjectMetadata_2_1;
            },
        ...
        execute: function () {
            ...
            Serializer = (function () {
                ...
                Serializer.writeObject = function (object, settings) {
                    var objectMetadata = JsonObjectMetadata_2.JsonObjectMetadata.getFromInstance(object);
                    var ObjectType;
                    if (objectMetadata) {
                ...
                Serializer.writeToJsonObject = function (object, settings) {
                    ...
                    var json;
                    var objectMetadata;
                    if (!Helpers_3.default.valueIsDefined(object)) {
                        // Uninitialized or null object returned "as-is" (or default value if set).
                        if (settings.emitDefault) {
                            json = Helpers_3.default.getDefaultValue(settings.objectType);
                        }
                        else {
                            json = object;
                        }
                    }
                    else if (Helpers_3.default.isPrimitive(object) || object instanceof Date) {
                        ...
                        objectMetadata = JsonObjectMetadata_2.JsonObjectMetadata.getFromInstance(object);
                        if (objectMetadata && typeof objectMetadata.serializer === "function") {
                            ...
                            if (settings.enableTypeHints && (settings.requireTypeHints || object.constructor !== settings.objectType)) {
                                json[settings.typeHintPropertyKey] = JsonObjectMetadata_2.JsonObjectMetadata.getKnownTypeNameFromInstance(object);
                            }
                            if (objectMetadata) {
            ...
            exports_12("Serializer", Serializer);
            //#endregion 
        }
    };
});
System.register("JsonObjectOptions", [], function (exports_13, context_13) {
    "use strict";
...
//#region "JsonObject"
System.register("JsonObject", ["JsonObjectMetadata", "Constants", "Helpers"], function (exports_14, context_14) {
    "use strict";
    ...
    function JsonObject(optionsOrTarget) {
        ...
        var decorator = function (target) {
            ...
            var parentMetadata;
            var i;
            if (!target.prototype.hasOwnProperty(Constants_3.Constants.METADATA_FIELD_KEY)) {
                objectMetadata = new JsonObjectMetadata_3.JsonObjectMetadata();
                // If applicable, inherit @JsonMembers and @KnownTypes from parent @JsonObject.
                if (parentMetadata = target.prototype[Constants_3.Constants.METADATA_FIELD_KEY]) {
                    // @JsonMembers
                ...
                Object.defineProperty(target.prototype, Constants_3.Constants.METADATA_FIELD_KEY, {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                ...
                objectMetadata = target.prototype[Constants_3.Constants.METADATA_FIELD_KEY];
            }
            ...
            if (options.knownTypes) {
                ...
                try {
                    ...
                    Helpers_4.default.error(new TypeError("@JsonObject: " + e.message + " (on '" + Helpers_4.default.getClassName(target) + "')"));
                }
            }
    ...
    exports_14("JsonObject", JsonObject);
    var JsonObjectMetadata_3, Constants_3, Helpers_4;
    return {
        setters: [
            function (JsonObjectMetadata_3_1) {
                JsonObjectMetadata_3 = JsonObjectMetadata_3_1;
            },
        ...
        execute: function () {//#region "JsonObject"
            //#endregion 
        }
    };
});
System.register("JsonMemberOptions", [], function (exports_15, context_15) {
    "use strict";
...
System.register("Reflect", [], function (exports_16, context_16) {
    "use strict";
...
//#region "JsonMember"
System.register("JsonMember", ["JsonMemberMetadata", "JsonObjectMetadata", "Helpers", "Reflect", "Constants"], function (exports_17, context_17) {
    "use strict";
        ...
        if (metadata.type === Array) {
            if (!metadata.elements) {
                if (warnArray) {
                    ...
                    Helpers_5.default.warn("No valid 'elements' option was specified for '" + propertyName + "'.");
                }
                else {
    ...
    function JsonMember(optionsOrTarget, propertyKey) {
        ...
        decorator = function (target, propertyKey) {
            ...
            var parentMetadata;
            var reflectType;
            var propertyName = Helpers_5.default.getPropertyDisplayName(target, propertyKey); // For error messages.
            ...
            if (options.hasOwnProperty("elementType")) {
                Helpers_5.default.warn(propertyName + ": the 'elementType' option is deprecated, use 'elements' instead.");
                options.elements = options.elementType;
                if (options.elementType === Array) {
                    memberMetadata.forceEnableTypeHinting = true;
                }
            }
            memberMetadata = Helpers_5.default.assign(memberMetadata, options);
            ...
            if (Helpers_5.default.isReservedMemberName(memberMetadata.name)) {
            ...
            if (typeof Reflect_1.Reflect === "object" && typeof Reflect_1.Reflect.getMetadata === "function") {
                ...
                if (!memberMetadata.type || typeof memberMetadata.type !== "function") {
                    ...
                    Helpers_5.default.warn("@JsonMember: 'type' specified for '" + propertyName + "' does not match detected type.");
                }
            }
            ...
            if (!target.hasOwnProperty(Constants_4.Constants.METADATA_FIELD_KEY)) {
                // No *own* metadata, create new.
                objectMetadata = new JsonObjectMetadata_4.JsonObjectMetadata();
                // Inherit @JsonMembers from parent @JsonObject, if any.
                if (parentMetadata = target[Constants_4.Constants.METADATA_FIELD_KEY]) {
                    Object.keys(parentMetadata.dataMembers).forEach(function (memberPropertyKey) {
                        objectMetadata.dataMembers[memberPropertyKey] = parentMetadata.dataMembers[memberPropertyKey];
                    });
                }
                // ('target' is the prototype of the involved class, metadata information is added to the class prototype).
                Object.defineProperty(target, Constants_4.Constants.METADATA_FIELD_KEY, {
                    enumerable: false,
                    configurable: false,
                    writable: false,
                    value: objectMetadata
                ...
                objectMetadata = target[Constants_4.Constants.METADATA_FIELD_KEY];
            }
            ...
            try {
                ...
                throw new Error("Member '" + memberMetadata.name + "' already exists on '" + Helpers_5.default.getClassName(objectMetadata.classType) + "'.");
            }
        };
        if (typeof propertyKey === "string" || typeof propertyKey === "symbol") {
    ...
    exports_17("JsonMember", JsonMember);
    var JsonMemberMetadata_1, JsonObjectMetadata_4, Helpers_5, Reflect_1, Constants_4;
    return {
        setters: [
            function (JsonMemberMetadata_1_1) {
                JsonMemberMetadata_1 = JsonMemberMetadata_1_1;
            },
            function (JsonObjectMetadata_4_1) {
                JsonObjectMetadata_4 = JsonObjectMetadata_4_1;
            },
            function (Helpers_5_1) {
                Helpers_5 = Helpers_5_1;
            },
            function (Reflect_1_1) {
                Reflect_1 = Reflect_1_1;
            },
...
System.register("bootstrap", ["Helpers", "JSON", "JsonObjectMetadata", "Deserializer", "Serializer", "JsonObject", "JsonMember"], function (exports_18, context_18) {
    "use strict";
    var __moduleName = context_18 && context_18.id;
    var Helpers_6, JSON_1, JsonObjectMetadata_5, Deserializer_1, Serializer_1, JsonObject_1, JsonMember_1, configSettings, TypedJSON;
    return {
        setters: [
            ...
            function (JsonObjectMetadata_5_1) {
                JsonObjectMetadata_5 = JsonObjectMetadata_5_1;
            },
            ...
            function (JsonObject_1_1) {
                JsonObject_1 = JsonObject_1_1;
            },
            function (JsonMember_1_1) {
                JsonMember_1 = JsonMember_1_1;
            }
        ],
        execute: function () {
            exports_18("JsonObject", JsonObject_1.JsonObject);
            exports_18("JsonMember", JsonMember_1.JsonMember);
            //#region "TypedJSON"
            // Default settings.
            configSettings = {
            ...
            TypedJSON = {
                config: function (settings) {
                    configSettings = Helpers_6.default.merge(configSettings, settings);
                },
                stringify: function (value, settings) {
                    return Serializer_1.Serializer.writeObject(value, Helpers_6.default.merge(configSettings, settings || {}));
                },
                parse: function (json, type, settings) {
                    if (JsonObjectMetadata_5.JsonObjectMetadata.getFromType(type)) {
                        return Deserializer_1.Deserializer.readObject(json, type, Helpers_6.default.merge(configSettings, settings || {}));
                    }
                    else {
            ...
            exports_18("TypedJSON", TypedJSON);
        }
    };
});
