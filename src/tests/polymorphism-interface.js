...
var SmallNode = (function () {
    ...
    ], SmallNode.prototype, "x");
    __decorate([
        bootstrap_1.JsonMember,
        __metadata("design:type", Number)
    ], SmallNode.prototype, "y");
    __decorate([
        bootstrap_1.JsonMember,
...
var GraphGrid = (function () {
    ...
    __decorate([
        bootstrap_1.JsonMember({ elements: Object, refersAbstractType: true }),
        __metadata("design:type", Array)
    ], GraphGrid.prototype, "points");
    __decorate([
        bootstrap_1.JsonMember({ refersAbstractType: true }),
        __metadata("design:type", Object)
    ], GraphGrid.prototype, "root");
...
function test(log) {
    ...
    var clone = bootstrap_1.TypedJSON.parse(json, GraphGrid);
    if (log) {
